...
module.exports = class Config {
   ...
   *
   * @method ServerConfig#getEnvValue
   ...
   * Set default values
   *
   * @method Config#setDefaultValues
   * @return { Config }               Self
   */
  setDefaultValues () {
    /**
    ...
    const setDefaultValues = (path = [], schema = this.schema.properties) => {
      for (const key in schema) {
        const schemaDefault = schema[key].default
        const envValue = this.getEnvValue([...path, key])

        const defaultValue = envValue != null ? envValue : schemaDefault
   ...
   *
   * @method Config#getPath
   * @param { mixed } path            String or an array of strings
   ...
   *
   * @method Config#validateBeforeSet
   * @param { string|string[] } [path]String or an array of strings
   * @param { mixed } value           Any value that can be serialized as JSON
   * @return { Config }               Self
   */
   ...
   *
   * @method Config#get
   * @param { string|string[] } paths String or an array of strings
